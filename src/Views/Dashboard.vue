<template>
<!--lorsque l'utilisateur aura un acces valide il sera dirigé sur dashboard/dash-->
    <div class="container">
        <div class="navigation">
            <ul>
                ...
                <li>
                    <router-link to="Dash" exact tag="button">
...
.navigation ul li a .icon .fa{ /** la couleur des icon */
    color:#fff;
    font-size: 24px;
}
